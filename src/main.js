    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ${[
            { iconName:"trophy",   title:"Instruktur Bersertifikat", desc:"Sensei dan pelatih berpengalaman dengan sertifikasi nasional & internasional." },
            { iconName:"users",    title:"Untuk Semua Usia",          desc:"Program khusus kids, adult, dan senior dengan kurikulum yang disesuaikan." },
            { iconName:"dumbbell", title:"Fasilitas Lengkap",         desc:"Dojo, ring Muay Thai, gym equipment modern dalam satu lokasi." },
            { iconName:"calendar", title:"Jadwal Fleksibel",          desc:"Kelas pagi, siang, dan malam. Pilih waktu yang paling cocok untukmu." },
          ].map(item => `
    ...
    <section id="service" class="py-20 section-dark">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ${[
            { iconName:"shield",   title:"Karate Class",       desc:"Latihan karate terstruktur dengan metode Shotokan. Membangun disiplin, koordinasi, dan kekuatan sejak dini.", tags:["kids","adult","senior"], features:["Teknik dasar & lanjutan","Ujian kenaikan sabuk","Turnamen & kompetisi","Pemanasan & pendinginan"], highlight:"Most Popular" },
            { iconName:"flame",    title:"Muay Thai",           desc:"Seni bela diri dari Thailand yang melatih kekuatan fisik, kelincahan, dan ketahanan mental secara menyeluruh.", tags:["adult"], features:["Teknik striking 8 senjata","Sparring & padwork","Conditioning training","Self-defense skills"], highlight:null },
            { iconName:"dumbbell", title:"Personal Trainer",    desc:"Latihan 1-on-1 dengan personal trainer bersertifikat. Program custom sesuai target dan kondisi tubuh kamu.", tags:["kids","adult","senior"], features:["Program latihan personal","Nutrition guidance","Progress tracking","Jadwal fleksibel"], highlight:"Recommended" },
            { iconName:"mappin",   title:"Dojo Rental",         desc:"Sewa dojo untuk latihan mandiri, event, atau kompetisi. Fasilitas lengkap dengan lantai matras berkualitas.", tags:["adult"], features:["Matras standar kompetisi","Cermin & mirror wall","Locker room","Kapasitas hingga 30 orang"], highlight:null },
            { iconName:"dumbbell", title:"Fitness / Gym",       desc:"Area fitness modern dengan peralatan lengkap untuk cardio dan strength training. Tersedia bagi semua member.", tags:["adult","senior"], features:["Treadmill & cardio area","Free weights & barbells","Resistance machines","Akses bebas jam operasional"], highlight:null },
            { iconName:"baby",     title:"Kids Special Class",  desc:"Program khusus anak usia 3–12 tahun yang fokus pada motorik, koordinasi, keseimbangan, dan kepercayaan diri.", tags:["kids"], features:["Fun-based learning","Gross motor development","Karakter & disiplin","Sertifikat kelulusan"], highlight:"For Kids" },
          ].map(s => `
            <div class="service-card relative rounded-2xl p-6 fade-up">
